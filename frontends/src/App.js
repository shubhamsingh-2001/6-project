import "./App.css";
//Importing necessary components and funtions from the react router dom library for routing.
import {
  createBrowserRouter,
...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OsmuaSEMPa4VQHAZyCpoOCrVBCw2Hlr4QWdSkOtqvnJLffGjjn0e91XoTaFqMKx6QQ1djwcwciiiB8zOg1wdaAL004G5klAfU"
  );
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      ...
      <Route path="/" element={<Main />} id="main " exact>
        ...
        <Route id="editprofie" path="editprofile" element={<EditProfile />} />
        <Route
          id="updatepassword"
